...
<script>
  function check_input() {
      if (!document.trip_form.subject.value)
      {
          alert("제목을 입력하세요!");
          document.trip_form.subject.focus();
          return;
      }
...
<section>
   	<div id="board_box">
	    ...
	    <form  name="trip_form" method="post" action="trip_insert.php" enctype="multipart/form-data">
	    	 <ul id="board_form">
	    		<li>
          ...
          <li>
            ...
            <span class="col2"><input name="purpose" type="text"></span>
          </li>
          <li>
	    	...
	    	<ul class="buttons">
				...
				<li><button type="button" onclick="location.href='trip_list.php'">목록</button></li>
			</ul>
	    </form>
	</div> <!-- board_box -->
</section>
